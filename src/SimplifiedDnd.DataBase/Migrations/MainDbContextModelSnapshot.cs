...
internal partial class MainDbContextModelSnapshot : ModelSnapshot {
  /// <summary>
  /// Configures the entity model for the MainDbContext, defining tables, properties, keys, indexes, and relationships for the Dungeons & Dragons schema.
  /// </summary>
