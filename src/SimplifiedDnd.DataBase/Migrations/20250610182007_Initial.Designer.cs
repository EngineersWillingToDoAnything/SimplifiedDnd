...
internal partial class Initial {
  /// <summary>
  /// Configures the Entity Framework Core model for the initial database schema, defining entities, properties, relationships, indexes, and PostgreSQL-specific settings for the main application context.
  /// </summary>
